...
from grammar import return_all, \
    return_coalesce, return_default, return_first, return_head, return_id, return_item, return_items, return_keys, \
    return_labels, return_limit, return_order_by, return_order_by_item, return_order_by_items, return_order_by_name, \
    return_order_by_selector, return_ordering, return_ordering_ascending, return_ordering_descending, return_parameter, \
    return_part, return_properties, return_property, return_selector, return_skip, return_synonym, return_tail, \
