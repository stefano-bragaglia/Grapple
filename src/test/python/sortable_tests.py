...
class TestSortableParsing(TestCase):
    def test_removable_0(self):
        assert_that(self.process(removable, '$ent :flag1:flag2')) \
            .contains_only('data') \
            .contains_entry({'data': {'entity': '$ent', 'flags': ['flag1', 'flag2']}})

    def test_removable_1(self):
        assert_that(self.process(removable, '$ent . "key"')) \
            .contains_only('data') \
    ...
    def test_descriptor_4(self):
        assert_that(self.process(descriptor, '$ent:flag1')) \
            .contains_only('data') \
            .contains_entry({'data': {'entity': '$ent', 'flags': ['flag1']}})
    ...
    def test_sortable_001(self):
        assert_that(self.process(sortable, '$ent')) \
            .contains_only('data') \
            .contains_entry({'data': {'ascending': True, 'entity': '$ent'}})
    ...
    def test_sortable_008(self):
        assert_that(self.process(sortable, '$ent DESC')) \
            .contains_only('data') \
            .contains_entry({'data': {'ascending': False, 'entity': '$ent'}})
    ...
    def test_sortable_015(self):
        assert_that(self.process(sortable, '$ent. ASC')) \
            .contains_only('data') \
            .contains_entry({'data': {'ascending': True, 'entity': '$ent', 'field': 'ASC'}})
    ...
    def test_sortable_018(self):
        assert_that(self.process(sortable, '$ent. ASCENDING')) \
            .contains_only('data') \
            .contains_entry({'data': {'ascending': True, 'entity': '$ent', 'field': 'ASCENDING'}})
    ...
    def test_sortable_021(self):
        assert_that(self.process(sortable, '$ent. DESC')) \
            .contains_only('data') \
            .contains_entry({'data': {'ascending': True, 'entity': '$ent', 'field': 'DESC'}})
    ...
    def test_sortable_024(self):
        assert_that(self.process(sortable, '$ent. DESCENDING')) \
            .contains_only('data') \
            .contains_entry({'data': {'ascending': True, 'entity': '$ent', 'field': 'DESCENDING'}})
    ...
    def test_sortable_040(self):
        assert_that(self.process(sortable, '$ent.key')) \
            .contains_only('data') \
            .contains_entry({'data': {'ascending': True, 'entity': '$ent', 'field': 'key'}})
    ...
    def test_sortable_047(self):
        assert_that(self.process(sortable, '$ent.key DESC')) \
            .contains_only('data') \
            .contains_entry({'data': {'ascending': False, 'entity': '$ent', 'field': 'key'}})
    ...
    def test_sortable_079(self):
        assert_that(self.process(sortable, 'reference')) \
            .contains_only('data') \
            .contains_entry({'data': {'ascending': True, 'name': 'reference'}})
    ...
    def test_sortable_086(self):
        assert_that(self.process(sortable, "reference DESC")) \
            .contains_only('data') \
            .contains_entry({'data': {'ascending': False, 'name': 'reference'}})
