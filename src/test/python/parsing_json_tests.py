...
from grapple.parsing.grammar import json_array, json_elements, json_false, json_integer, json_key, json_member, \
...
class TestGrammarVisitor(TestCase):
    ...
    def test_json_object_2(self):
        assert_that(self.process(json_object, '{\'k1\': -5, "k2": .123, k3: {}, \'k4\': ["value"], '
            ...
            .contains_only('value') \
            .contains_entry({'value': {'k1': -5, 'k2': 0.123, 'k3': {}, 'k4': ['value'],
    ...
    def test_json_member_3(self):
        assert_that(self.process(json_member, "'key': 'value'")) \
            .contains_only('value') \
            .contains_entry({'value': {'key': 'value'}})
    ...
    def test_json_elements_0(self):
        assert_that(TestGrammarVisitor.process) \
            ...
            .starts_with("Expected ''' or '\"' or json_real or json_integer or '{' or '[' or json_true or json_false "
                         "or json_null or parameter at position")
